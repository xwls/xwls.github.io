...
使用命令查看目前「TCP 动态端口」的范围。

```cmd
netsh int ipv4 show dynamicport tcp
```

![202210111541566](https://xwls-oss.netlify.app/images/202210111541566.webp)

这只是一个「待选择」范围，并不代表其中的所有端口都会被保留，只是有一部分会被 Hyper-V 征用。使用命令可以查看当前所有已经被征用了的端口。

```cmd
netsh int ipv4 show excludedportrange protocol=tcp
```

![202210111541429](https://xwls-oss.netlify.app/images/202210111541429.webp)
...
![202210111541275](https://xwls-oss.netlify.app/images/202210111541275.webp)

然后重启电脑即可。

重启电脑后，再运行命令 `netsh int ipv4 show dynamicport tcp` 查看动态端口范围，发现确实已经修改为了 49152-65535。现在只有这个范围内的端口可能会被保留了，基本不会影响日常使用。

![202210111541615](https://xwls-oss.netlify.app/images/202210111541615.webp)